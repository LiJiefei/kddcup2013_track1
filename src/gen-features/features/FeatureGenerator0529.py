...
class FeatureGenerator0529:
    def __init__(self, data):
        self.data = data
        self.authorpaper_simi_dict = read_dading_simi_csv(self.data.info_input + '/dading_data/0529_similarity/similarity.feature.csv')
        return
